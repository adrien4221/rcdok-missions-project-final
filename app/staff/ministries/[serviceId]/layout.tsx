...
export default async function MinistryDashboardLayout({
  ...
  const tabs = [
    { name: 'Analytics', href: `/staff/ministries/${serviceId}/analytics`, icon: <BarChart3 size={18} /> },
    { name: 'Submit Activity', href: `/staff/ministries/${serviceId}/submit`, icon: <ClipboardEdit size={18} /> },
    { name: 'Activity Log', href: `/staff/ministries/${serviceId}/log`, icon: <ListOrdered size={18} /> },
  ];
