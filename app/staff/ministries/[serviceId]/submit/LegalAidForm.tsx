...
export default function LegalAidForm({ 
      ...
      if (onSuccess) {
        ...
        alert(
          initialData
            ...
            : "Legal Intake Successfully Logged!"
        );
  ...
  useEffect(() => {
      ...
      setProblemType(details.problem_type || 'Civil');
      setPriorityLevel(details.priority_level || 'Medium');
      setProblemDescription(details.problem_description || '');

      setAssignedLawyer(details.assigned_lawyer || '');
      setInitialNotes(details.initial_notes || '');
    }, [initialData]);
